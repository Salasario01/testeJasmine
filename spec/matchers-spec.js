         ...
         describe("Suite de testes do toBeNull",function(){
          ...
          //acieta qualquer valor valído != 'false'
           ...
           //toContain
            ...
            //beforeEach 
            describe("Súite de testes do beforeEach",function(){
            var contador = 0;
            beforeEach(function()  {
            caontador++;   
            });   
            ...
            //beforeAll
            describe("Suite de testes do beforeAll",function(){
            var contador
            beforeAll(function() {
            contador = 10; 
            });
            ...
            describe("Suite de testes do afterAll",function(){
               ...
               //aninhando Suites 
               describe("Suites de testes 'aninhando suites'", function(){
               var contadorExterno = 0;
               beforeEach(function(){
               contadorExterno++;   
               });
               it("deve ter incremento o contador externo para 1",function(){
               expect(contadorExterno).toEqual(1);   
               });
               describe("Suites aninhando a anterior'", function(){
               var contadorIxterno = 0;
               beforeEach(function(){
               contadorInterno++;   
               });
